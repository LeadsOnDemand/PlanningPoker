...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Cards = __webpack_require__(186);
	var Leave = __webpack_require__(187);
	...
	var Table = React.createClass({
	  ...
	  handleFold: function handleFold(currentplayer) {
	    ...
	    this.setState({
	      ...
	      playerchoice: [].concat(_toConsumableArray(this.state.playerchoice), [{ name: currentplayer, choice: "fold" }])

	    });
	  },

	  handleCheck: function handleCheck(currentplayer) {
	    ...
	    this.setState({
	      ...
	      players: this.state.players,
	      playersyettoplay: this.state.playersyettoplay - 1,
	      playerchoice: [].concat(_toConsumableArray(this.state.playerchoice), [{ name: currentplayer, choice: "checked" }])

	    });
	  },

	  handleSubmit: function handleSubmit(playername) {

	    if (this.state.count == 1) {
	      this.setState({
	        totalplayers: [].concat(_toConsumableArray(this.state.totalplayers), [playername]),
	  ...
	  leaveTable: function leaveTable(filteredplayers, removeplayer) {
	    ...
	    this.setState({
	      ...
	      playerchoice: [].concat(_toConsumableArray(filteredchoice)),
	      count: this.state.count - 1,
	  ...
	  render: function render() {
	    ...
	    var countplayers = function countplayers() {
	    ...
	    var totalplayers = function totalplayers() {
	          ...
	          if (current != "player left") {
	            return React.createElement(
	              ...
	              React.createElement(
	                'div',
	                null,
	                React.createElement(Count, { onFold: that.handleFold, onCheck: that.handleCheck, currentplayer: current, allplayers: allplayers, count: count }),
	                React.createElement(Leave, { onLeave: that.leaveTable, currentplayer: current, allplayers: allplayers })
	              ),
	    ...
	    return React.createElement(
	      ...
	      React.createElement(Player, { onSubmit: this.handleSubmit }),
	      React.createElement('br', null),
	      totalplayers(),
	      React.createElement('br', null),
	      countplayers(),
	...
	var Cards = React.createClass({
	    ...
	    componentDidMount: function componentDidMount() {
	        ...
	        axios.get('https://deckofcardsapi.com/api/deck/fjt3ifclrhos/draw/?count=2').then(function (res) {
	            ...
	            that.setState({
	                ...
	                cards: [].concat(_toConsumableArray(res.data.cards))
	    ...
	    render: function render() {
	        var cards = this.state.cards.map(function (current) {
	            ...
	            return React.createElement("img", { src: current.image, width: "50", height: "50" });
	        });
	        return React.createElement(
	            "div",
	            null,
	      ...
	      return React.createElement(
	        ...
	        { onClick: function onClick() {
	            var filteredplayers = allplayers.map(function (current) {
	              ...
	              if (current == removeplayer) return "player left";else return current;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Count = React.createClass({
	    ...
	    render: function render() {
	        ...
	        var clickedstatus = function clickedstatus() {
